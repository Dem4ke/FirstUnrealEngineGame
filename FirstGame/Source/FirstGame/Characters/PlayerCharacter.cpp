...
void APlayerCharacter::OnStartCrouch(float HalfHeightAdjust, float ScaleHalfHeightAdjuts)
{
...
void APlayerCharacter::OnEndCrouch(float HalfHeightAdjust, float ScaleHalfHeightAdjuts)
{
